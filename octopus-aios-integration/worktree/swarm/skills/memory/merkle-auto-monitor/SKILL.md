...
## Инструкции
1. Использовать `/opt/octopus-merkle-check.sh`.
2. Запускать через systemd timer.
3. При ошибке (exit code 1) отправлять алерт в Telegram.
...
- Описание назначения: Операционный навык Octopus: merkle-auto-monitor.
