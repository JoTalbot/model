...
## Описание
Octopus: alert if memory_copies_audit.json shows coverage < 1.0 or stale.
...
- Описание назначения: Octopus: alert if memory_copies_audit.json shows coverage < 1.0 or stale.
