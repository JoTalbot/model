...
## Описание
Small, no-secret Garage health probe for Octopus alerts/dashboards.
...
- Описание назначения: Small, no-secret Garage health probe for Octopus alerts/dashboards.
